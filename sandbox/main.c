...
// ===== flags subcommand =====
static int run_flags(nil_clix_options options, void* context)
{
    (void)context;
...
// ===== numbers subcommand =====
static int run_numbers(nil_clix_options options, void* context)
{
    (void)context;
...
// ===== params subcommand =====
static int run_params(nil_clix_options options, void* context)
{
    (void)context;
...
// ===== root execution =====
static int run_root(nil_clix_options options, void* context)
{
    (void)context;
